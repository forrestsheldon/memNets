...
\column{0.5\textwidth}
\centering
\only<1>{\includegraphics[width=0.8\textwidth]{hysteresis.png}}
\only<2>{\includegraphics[width=0.8\textwidth]{hysteresis_on.png}}
\only<3>{\includegraphics[width=0.8\textwidth]{hysteresis_off.png}}
\onslide<4->{\includegraphics[width=0.8\textwidth]{hysteresis_thresh.png}}
\column{0.5\textwidth}
\centering
\onslide<6->{\includegraphics[width=0.6\textwidth]{Granular_Material.png}}
\end{columns}
\begin{center}
\onslide<5->{\includegraphics[width=\textwidth]{Atomic_Switch_Filament.png}}
\end{center}
\end{frame}

...
organic synapses such as short-term and long-term potentiation.  As such, devices
based on memristors proposed for neuromorphic computing
and are receiving experimental attention.  However, little is known about the
dynamics of these devices in networks.  We propose a model for disordered memristive
network in

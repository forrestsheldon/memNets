...
the total power dissipated by the network for given boundary conditions.  By
utilizing an effective medium approximation for the conductivity of the network
as a function of $f$, the fraction of devices in their ON conductive state.
Formulating the network in a voltage-controlled setting (See Supplemental
Material at HERE for a more detailed derivation of the self-consistency
equation.) yields,
